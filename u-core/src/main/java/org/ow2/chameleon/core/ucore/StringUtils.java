...
public final class StringUtils {
    ...
    /**
     * Constructor to avoid creating new String Utils instances.
     */
    private StringUtils() { }

    /**
     * Returns true if and only if the given string contains the specified
     * sequence of char values.
     * @param string the string to analyze
     * @param s the sequence to search for
     * @return true if the string <code>string</code> contains <code>s</code>,
     *  false otherwise
     */
    ...
    public static String substVars(String val, String currentKey,
        ...
        do {
            ...
            while (stopDelim >= 0) {
                int idx =
                        val.indexOf(DELIM_START, startDelim
                                + DELIM_START.length());
